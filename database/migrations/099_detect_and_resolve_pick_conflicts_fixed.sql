-- Migration 099: Detect and resolve existing pick set conflicts (FIXED VERSION)
...
DECLARE
    ...
    row_count_temp INTEGER;  -- Fixed: Add temporary variable for ROW_COUNT
BEGIN
    ...
    LOOP
        ...
        -- Fixed: Get ROW_COUNT into temporary variable, then add to running total
        GET DIAGNOSTICS row_count_temp = ROW_COUNT;
        updates_made := updates_made + row_count_temp;
        
        RAISE NOTICE '  Deactivated % anonymous picks', row_count_temp;
    END LOOP;
...
BEGIN
    RAISE NOTICE '';
    RAISE NOTICE '🎉 MIGRATION 099 COMPLETE: CONFLICT DETECTION & RESOLUTION (FIXED)';
    RAISE NOTICE '================================================================';
    RAISE NOTICE '';
    ...
    RAISE NOTICE '  - FIXED: GET DIAGNOSTICS syntax error in step 3';
    RAISE NOTICE '';
    RAISE NOTICE '🔧 FIXED ISSUE:';
    RAISE NOTICE '  - Changed: GET DIAGNOSTICS updates_made = updates_made + ROW_COUNT';
    RAISE NOTICE '  - To: GET DIAGNOSTICS row_count_temp = ROW_COUNT; updates_made := updates_made + row_count_temp';
    RAISE NOTICE '  - PostgreSQL requires temporary variable for arithmetic operations';
    RAISE NOTICE '';
